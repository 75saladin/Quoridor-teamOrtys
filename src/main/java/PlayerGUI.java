...
public class PlayerGUI extends Application {
    ...
    public void start(Stage stage) {
        grid = drawGrid(2);
        TRUMPwall();
        Scene scene = new Scene(grid, 100, 100, Color.BLUE);
