 ...
 * @author jed_lechner
 */
public class userGUI extends Application implements GUIInterface {
    ...
    public static userGUI waitForGUIStartUpTest()  {
        try {
            latch.await();
     ...
     */
    public static void guiStartUpTest(userGUI g) {
        gui = g;
        latch.countDown();
    }
